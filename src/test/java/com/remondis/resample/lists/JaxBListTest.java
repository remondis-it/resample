...
public class JaxBListTest {
  ...
  @Test
  public void shouldFillJaxBLists() {
  ...
  @Test
  public void autosampleShouldFillJaxBLists() {
    JaxBListDtoWrapper wrapper = Samples.of(JaxBListDtoWrapper.class)
        .collectionSamplingMode(USE_GETTER_AND_ADD)
        .useForEnum(enumValueSupplier())
        .use(fieldNameStringSupplier())
        .forType(String.class)
    ...
    JaxBListDto instance = wrapper.getJaxBListDto();
